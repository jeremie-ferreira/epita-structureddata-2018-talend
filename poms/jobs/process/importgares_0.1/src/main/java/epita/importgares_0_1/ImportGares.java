...
/**
 * Job: ImportGares Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class ImportGares implements TalendJob {
	...
	private final String jobName = "ImportGares";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ImportGares.this, new Object[] { e,
	...
	public static class row6Struct implements
		...
		final static byte[] commonByteArrayLock_EPITA_ImportGares = new byte[0];
		static byte[] commonByteArray_EPITA_ImportGares = new byte[0];
		...
		public int getCode_uic() {
			return this.code_uic;
		}

		public String libelle_gare;

		public String getLibelle_gare() {
			return this.libelle_gare;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.code_uic;
		...
		public boolean equals(Object obj) {
			...
			if (this.code_uic != other.code_uic)
				return false;
		...
		public void copyDataTo(row6Struct other) {
			...
			other.code_uic = this.code_uic;
			other.libelle_gare = this.libelle_gare;
			other.fret = this.fret;
			other.lat = this.lat;
			other.lon = this.lon;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EPITA_ImportGares) {

				try {

					int length = 0;

					this.code_uic = dis.readInt();
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.libelle_gare = readString(dis, ois);

				this.fret = dis.readChar();
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.libelle_gare, dos, oos);

				dos.writeChar(this.fret);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("code_uic=" + String.valueOf(code_uic));
			sb.append(",libelle_gare=" + libelle_gare);
			sb.append(",fret=" + String.valueOf(fret));
		...
		public int compareTo(row6Struct other) {
			...
			returnValue = checkNullsAndCompare(this.code_uic, other.code_uic);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class outStruct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EPITA_ImportGares.length) {
					if (length < 1024
							&& commonByteArray_EPITA_ImportGares.length == 0) {
						commonByteArray_EPITA_ImportGares = new byte[1024];
					} else {
						commonByteArray_EPITA_ImportGares = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EPITA_ImportGares, 0, length);
				strReturn = new String(commonByteArray_EPITA_ImportGares, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EPITA_ImportGares) {
				...
				try {
					...
					this.libelle_gare = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.libelle_gare, dos);
	...
	public static class row1Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.code_uic == null) ? 0 : this.code_uic
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.code_uic == null) {
				if (other.code_uic != null)
					return false;

			} else if (!this.code_uic.equals(other.code_uic))
	...
	public static class out5Struct implements
		...
		public Character fret;

		public Character getFret() {
			return this.fret;
		}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.code_uic, dos);
	...
	public void tFileInputJSON_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tUnite_1 - inputs:(out,out5) outputs:(row6,row6)
				// | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
				// linked node: tMap_1 - inputs:(row6,row4) outputs:(gare)
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime
									* result
									+ ((this.code_uic == null) ? 0
											: this.code_uic.hashCode());
				...
				try {
					filenameOrStream_tFileInputJSON_1 = "G:/epita/data/liste-des-gares.json";
				...
				for (Object row_tFileInputJSON_1 : resultset_tFileInputJSON_1) {
					...
					try {
						jsonPath_tFileInputJSON_1 = "fields.code_uic";
						...
						try {
							...
							row1.code_uic = value_tFileInputJSON_1 == null ?
						...
						jsonPath_tFileInputJSON_1 = "fields.libelle_gare";
						compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1
								.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
						...
						try {
							value_tFileInputJSON_1 = compiledJsonPath_tFileInputJSON_1
									.read(row_tFileInputJSON_1);
							row1.libelle_gare = value_tFileInputJSON_1 == null ?
						...
						jsonPath_tFileInputJSON_1 = "fields.fret";
						compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1
								.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
						...
						try {
							value_tFileInputJSON_1 = compiledJsonPath_tFileInputJSON_1
									.read(row_tFileInputJSON_1);
							if (value_tFileInputJSON_1 != null
									&& !value_tFileInputJSON_1.toString()
											.isEmpty()) {
								row1.fret = ParserUtils
										.parseTo_char(value_tFileInputJSON_1
												.toString());
							} else {
								row1.fret =
						...
						jsonPath_tFileInputJSON_1 = "geometry.coordinates[0]";
						compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1
								.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
						...
						try {
							...
							if (value_tFileInputJSON_1 != null
								...
								row1.lat = ParserUtils
										.parseTo_double(value_tFileInputJSON_1
												.toString());
							} else {
								row1.lat =
						...
						jsonPath_tFileInputJSON_1 = "geometry.coordinates[1]";
						compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1
								.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
					...
					if (row1 != null) {
						...
						row2 = null;
						if (row1.code_uic == null) {
							finder_tUniqRow_1.code_uic = null;
						} else {
							finder_tUniqRow_1.code_uic = row1.code_uic
									.toLowerCase();
						}
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							if (row1.code_uic == null) {
								new_tUniqRow_1.code_uic = null;
							} else {
								new_tUniqRow_1.code_uic = row1.code_uic
										.toLowerCase();
							}
							...
							row2.code_uic = row1.code_uic;
							row2.libelle_gare = row1.libelle_gare;
							row2.fret = row1.fret;
							row2.lat = row1.lat;
							row2.lon = row1.lon;
						...
						if (row2 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'out'
								out_tmp.code_uic = ((int) Double
										.parseDouble(row2.code_uic)) - 87000000;
								out_tmp.libelle_gare = row2.libelle_gare;
								out_tmp.fret = row2.fret;
								out_tmp.lat = row2.lat;
								out_tmp.lon = row2.lon;
								out = out_tmp;
								// ###############################
							...
							if (out != null) {
								...
								row6.code_uic = out.code_uic;
								row6.libelle_gare = out.libelle_gare;
								row6.fret = out.fret;
								row6.lat = out.lat;
								row6.lon = out.lon;
								...
								row6_HashRow.code_uic = row6.code_uic;

								row6_HashRow.libelle_gare = row6.libelle_gare;

								row6_HashRow.fret = row6.fret;

								row6_HashRow.lat = row6.lat;

								row6_HashRow.lon = row6.lon;
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "G:/epita/data/stations-correction.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"G:/epita/data/stations-correction.csv",
								"US-ASCII", "|", "\n", false, 0, 0, -1, -1,
								false);
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.lon = ParserUtils.parseTo_Double(temp);
							...
							row5.label = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row5 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'out5'
								out5_tmp.code_uic = row5.code;
								out5_tmp.libelle_gare = row5.label;
								out5_tmp.fret = Var.var1;
								out5_tmp.lat = row5.lat;
								out5_tmp.lon = row5.lon;
								out5 = out5_tmp;
								// ###############################
							...
							if (out5 != null) {
								...
								row6.code_uic = out5.code_uic;
								row6.libelle_gare = out5.libelle_gare;
								row6.fret = out5.fret;
								row6.lat = out5.lat;
								row6.lon = out5.lon;
					...
					if (!((Object) ("G:/epita/data/stations-correction.csv") instanceof java.io.InputStream)) {
	...
	public void tFileInputXML_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_6 = "gare";
				...
				java.sql.PreparedStatement pstmt_tDBOutput_6 = conn_tDBOutput_6
						.prepareStatement("SELECT COUNT(1) FROM `" + "gare"
								+ "` WHERE `code` = ?");
				String insert_tDBOutput_6 = "INSERT INTO `" + "gare"
						+ "` (`code`,`libelle`) VALUES (?,?)";

				java.sql.PreparedStatement pstmtInsert_tDBOutput_6 = conn_tDBOutput_6
						.prepareStatement(insert_tDBOutput_6);
				String update_tDBOutput_6 = "UPDATE `" + "gare"
						+ "` SET `libelle` = ? WHERE `code` = ?";
					...
					for (org.dom4j.tree.AbstractNode temp_tFileInputXML_2 : nodeList_tFileInputXML_2) {
						...
						try {
							...
							if (xml_api_tFileInputXML_2
								...
								row3.libelle = str_tFileInputXML_2;
							}
							...
							if (xml_api_tFileInputXML_2
								...
								row3.code1 = str_tFileInputXML_2;
							}
						...
						if (row3 != null) {
							...
							row4 = null;
							finder_tUniqRow_2.code = row3.code;
							finder_tUniqRow_2.hashCodeDirty = true;
							if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
								KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

								new_tUniqRow_2.code = row3.code;
								...
								row4.code = row3.code;
								row4.libelle = row3.libelle;
								row4.code1 = row3.code1;
								row4.code_gare = row3.code_gare;
							...
							if (row4 != null) {
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									Object exprKeyValue_row6__code_uic = row4.code;
									if (exprKeyValue_row6__code_uic == null) {
										hasCasePrimitiveKeyWithNull_tMap_1 = true;
									} else {
										row6HashKey.code_uic = (int) (Integer) exprKeyValue_row6__code_uic;
									}
								...
								if (tHash_Lookup_row6 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.code_uic = '"
									// + row6HashKey.code_uic + "'");
								} // G 071
								...
								{ // start of Var scope
									...
									if (!rejectedInnerJoin_tMap_1) {
										...
										// # Output table : 'gare'
										gare_tmp.code = row4.code;
										gare_tmp.libelle = row6.libelle_gare;
										gare = gare_tmp;
								...
								if (gare != null) {
									...
									pstmt_tDBOutput_6.setInt(1, gare.code);
									...
									if (checkCount_tDBOutput_6 > 0) {
										...
										pstmtUpdate_tDBOutput_6.setInt(
												2 + count_tDBOutput_6,
												gare.code);
										...
										pstmtInsert_tDBOutput_6.setInt(1,
												gare.code);
										...
										if (gare.libelle == null) {
											...
											pstmtInsert_tDBOutput_6.setString(
													2, gare.libelle);
										}
	...
	public static void main(String[] args) {
		final ImportGares ImportGaresClass = new ImportGares();

		int exitCode = ImportGaresClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ImportGares.class.getClassLoader()
					.getResourceAsStream(
							"epita/importgares_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = ImportGares.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : ImportGares");
		}
...
/************************************************************************************************
 * 145918 characters generated by Talend Open Studio for Data Integration on the
 * 1 juillet 2018 22:07:25 CEST
 ************************************************************************************************/
